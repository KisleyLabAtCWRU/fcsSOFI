function LocatStore = LRG_SuperRes_Particle_Identify(im, e, Bkg, bg)
...
wide = floor(wide2);
n = 3;%e.sigma; % how many std to add up as a threshold
[v, h] = size(im);
%{
...
thd_map = bg*eBT + n * sd;% determine the local threshold
else
