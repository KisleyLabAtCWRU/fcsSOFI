...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%% USER INPUT %%%%%%%%%%%%%%%%%%%%%%%%%%%% %%
fname='dataset3_analyzed_anomalous_manipulatable_04-10-2020_12-46.mat'; %string ending in .mat of your file of data in the current directory
...
cmin=5; %min log(D) plotted; default 3 
cmax=8; %max log(D); default 6
...
shift=0.3;%shift left right; default 0
scale=0.9;%factor to multiply everything by; default 0.7 
normcoef=10; %default 10
steps=25; %number of steps between min/max; default 25

% SATURATION - set the range of the SOFI and fcsSOFI image
satmax=0.3; %set to 1 if want entire range of data; decrease <1 to increase saturation; default 1
